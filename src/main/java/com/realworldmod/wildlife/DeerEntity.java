 ...
 * once hit) and drifts toward other nearby deer ({@link HerdWithOthersGoal})
 * rather than wandering solo. {@link com.realworldmod.wildlife.PoachingHandler}
 * now only reacts to killing *this* entity, not arbitrary livestock — see
 * ROADMAP.md for the zoo/predator/migration gaps still open.
 */
public final class DeerEntity extends PathAwareEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new FleeFromPlayerGoal(this));
        this.goalSelector.add(2, new HerdWithOthersGoal(this));
